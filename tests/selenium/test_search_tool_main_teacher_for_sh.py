...
class TestSearchTool(TestSetup):
    ...
    def setUp(self):
        """
        Test setup just to add
        xpath's that we'll use in the tests
        """
    ...
    def _search_by_enter(self, search_text='',
                ...
                fail_msg='test FAIL'):
        """
        This method implements test of search tool through pressing
        key 'Enter', not by pressing button 'Search'
        """
