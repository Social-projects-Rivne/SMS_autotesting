# -*- coding: utf-8 -*-
""" Tests on Selenium WebDriver logout"""
import time
import unittest
...
class Logout_main(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.find_element_by_xpath(xpaths['inputUsername']).send_keys(self._login_main)
        self.driver.find_element_by_xpath(xpaths['inputPassword']).send_keys(self._password_main)
    ...
    def test_logout_main_teacher(self):
        ...
        link.click()
        self.element = driver.find_element_by_tag_name(xpaths['submitButtonLogin'])
...
class Logout_director(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.maximize_window()
        self.driver.get(self._baseurl)
        self.driver.find_element_by_xpath(xpaths['inputUsername']).send_keys(self._login_director)
        self.driver.find_element_by_xpath(xpaths['inputPassword']).send_keys(self._password_director)
        self.driver.find_element_by_tag_name(xpaths['submitButtonLogin']).click()
...
class Logout_teacher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.maximize_window()
        self.driver.get(self._baseurl)
        self.driver.find_element_by_xpath(xpaths['inputUsername']).send_keys(self._login_teacher)
        self.driver.find_element_by_xpath(xpaths['inputPassword']).send_keys(self._password_teacher)
        self.driver.find_element_by_tag_name(xpaths['submitButtonLogin']).click()
